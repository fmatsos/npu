...
backend, end it, see what is up, read what it printed. `npu backend tune` sizes the static
context of NPU-compiled models from the model and the host's RAM. What gets started comes from the backend's
